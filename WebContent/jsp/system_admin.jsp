...
<%
	...
	<form name="adminForm" method="POST" action="<%= BbUtils.getFullPath("SystemAdmin") %>">
		...
		<bbUI:step title="<%= BbUtils.getSystemString( "system-config-authentication.title", locale ) %>">
			...
			<!--
			<bbUI:dataElement label="<%= BbUtils.getSystemString( "system-config-set-clientid.title", locale ) %>">
				<input type="text" name="<%= PerceptionSettings.CLIENT_ID_PARAM %>" value="<%= WebUtils.parseFormValue( settings.getClientID() ) %>">
			</bbUI:dataElement>	
			<bbUI:instructions>
				<%= BbUtils.getSystemString( "system-config-set-clientid.instructions", locale ) %>
			</bbUI:instructions>
			<bbUI:dataElement label="<%= BbUtils.getSystemString( "system-config-set-clientpassword.title", locale ) %>">
				<input type="text" name="<%= PerceptionSettings.CLIENT_PASSWORD_PARAM %>" value="<%= WebUtils.parseFormValue( settings.getClientPassword() ) %>">
			</bbUI:dataElement>	
			<bbUI:instructions>
				<%= BbUtils.getSystemString( "system-config-set-clientpassword.instructions", locale ) %>
			</bbUI:instructions>
			// -->
			...
			<!--
			<bbUI:dataElement label="<%= BbUtils.getSystemString( "system-config-set-trustedsecretkey.title", locale ) %>">
				<input type="password" name="<%= PerceptionSettings.TRUSTED_SECRET_KEY_PARAM %>" value="<%= WebUtils.parseFormValue( settings.getTrustedSecretKey() ) %>">
			</bbUI:dataElement>	
			<bbUI:instructions>
				<%= BbUtils.getSystemString( "system-config-set-trustedsecretkey.instructions", locale ) %>
			</bbUI:instructions>
			// -->
		</bbUI:step>
