...
<bbData:context id="ctx">
	<bbUI:docTemplateHead title="Modify Schedule"/>
	<bbUI:docTemplateBody >
		<bbUI:receipt type="PASS" title="Questionmark Scheduled Assessment">
			<i>
				You can't edit schedules using the Perception Connector
