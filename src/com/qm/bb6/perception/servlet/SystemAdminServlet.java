...
public class SystemAdminServlet extends AuthenticatedServlet {
	...
	//		settings.setTrustedSecretKey( request.getParameter(PerceptionSettings.TRUSTED_SECRET_KEY_PARAM));
			...
			settings.setDefaultGradeBookResultType( WebUtils.readInt(request.getParameter(PerceptionSettings.DEFAULT_GRADE_BOOK_RESULT_TYPE_PARAM), settings.getDefaultGradeBookResultType()));
			settings.setDefaultAssessmentTarget( WebUtils.readInt(request.getParameter(PerceptionSettings.DEFAULT_ASSESSMENT_TARGET_PARAM), settings.getDefaultAssessmentTarget()));
			settings.setUseBbWYSIWYG( WebUtils.readBoolean(request.getParameter(PerceptionSettings.USE_BB_WYSIWYG_PARAM), settings.getUseBbWYSIWYG()));
			settings.setUseAnnouncements( WebUtils.readBoolean(request.getParameter(PerceptionSettings.USE_ANNOUNCEMENTS_PARAM), settings.getUseAnnouncements()));
