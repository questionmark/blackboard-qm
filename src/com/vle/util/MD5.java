...
//	private static
	...
	/**
	 * Encodes a string to MD5 and returns the MD5 as a String
	 * @param str    to encode
	...
	/**
	 * Encodes a string to MD5 with a given charset and returns the MD5 as a String
	 * @param str    to encode
	 * @throws NullPointerException  if str is null
	 */
