...
<html>
	...
	<body>
		...
		<bbUI:docTemplateBody onLoad="disable_set_access()">
			<bbUI:titleBar iconUrl="images/qm.gif">Questionmark Perception connector</bbUI:titleBar>
			<%
				...
				if(crsMembership.getRole() == CourseMembership.Role.INSTRUCTOR
					...
					<div id="actionbar" class="actionBar clearfix editmode">
						<ul id="nav" class="nav clearfix">
							<li class="mainButton" nowrap="nowrap">
								<a href="links/forcesync.jsp?course_id=<%=courseId%>">Synchronize users now</a>
							</li>
							<%
					...
					<% } else { %>
						<form action="links/main.jsp#Results" method="GET" >
						...
						for(int i = 1; i <= numPages; i++) {
							if(request.getParameter("resultPage") != null && new Integer(request.getParameter("resultPage")).intValue() == i) {
								...
								out.println("<a href=\"links/main.jsp?course_id=" + courseId + 
									"&amp;resultPage=" + i +
					...
					<% } else { %>
						...
						<form name="schedule_assessment" action="links/scheduleassessment.jsp" method="post">
